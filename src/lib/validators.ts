...
export const addUnitSchema = z.object({
  ...
  m: z.string().max(20).optional().default(''),
  cc: z.string().max(20).optional().default(''),
  ct: z.string().max(20).optional().default(''),
  f: z.string().max(20).optional().default(''),
  e: z.string().max(20).optional().default(''),
  pv: z.string().max(20).optional().default(''),
  i: z.string().max(20).optional().default(''),
  a: z.string().max(20).optional().default(''),
  cd: z.string().max(20).optional().default(''),
})

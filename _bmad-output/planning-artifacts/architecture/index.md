...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Technical Preferences](./starter-template-evaluation.md#technical-preferences)
    - [Starter Options Considered](./starter-template-evaluation.md#starter-options-considered)
    - [Selected Starter: TanStack CLI with Official Add-ons](./starter-template-evaluation.md#selected-starter-tanstack-cli-with-official-add-ons)
  ...
  - [Architecture Validation Results](./architecture-validation-results.md)
    ...
    - [Gap Analysis — Issues Found & Resolved](./architecture-validation-results.md#gap-analysis-issues-found-resolved)
